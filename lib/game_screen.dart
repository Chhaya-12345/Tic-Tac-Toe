              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      currentPlayer == 'X' ? widget.player1 + " ($currentPlayer)" : widget.player2 + " ($currentPlayer)",
                      style: TextStyle(
                        fontSize: 30,
                        fontWeight: FontWeight.bold,
                        color: currentPlayer == 'X' ? Colors.white : Colors.white,
                      ...
                      child: Container(
                        ...
                        child: Center(
                          ...
                          style: TextStyle(
                            fontSize: 120,
                            fontWeight: FontWeight.bold,
                            color: board[row][col] == 'X' ? Colors.black : Colors.black,
                          ),),
                        ),
                      ),
                    );
